...
import { z } from "zod";
import { generateInvoice } from "./api/GenerateInvoiceApi.js";
...
server.tool("generate-invoice", "Generates an invoice PDF from a list of orders", {
    orders: z.object({
        customer: z.object({
            name: z.string(),
            email: z.string(),
    ...
    fileName: z
        .string()
        .describe("The name of the generated file using first_last.pdf of customer"),
    ...
    try {
        ...
        const data = await generateInvoice(orders, outputPathAndFile);
        return {
            content: [
                {
                    type: "text",
        ...
        return {
            content: [
                {
                    type: "text",
                    text: `Error generating invoice: ${error instanceof Error ? error.message : String(error)}`,
                },
            ],
        };
    }
